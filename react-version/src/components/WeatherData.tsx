  ...
  if (!weather) {
    return (
      <div className={`text-center py-8 ${className}`}>
        ...
        <p className="text-gray-500">天気データを取得中...</p>
      </div>
    );
  }
    ...
    <div className={`space-y-6 ${className}`}>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="text-center">
            ...
            <div className="text-2xl font-bold text-gray-900">{current.windSpeed}m/s</div>
          ...
          <div className="text-center">
            ...
            <div className="text-2xl font-bold text-gray-900">{current.pressure}hPa</div>
            <div className="text-sm text-gray-600">気圧</div>
          </div>
        </div>
        ...
        <div className="mt-4 p-3 bg-gray-50 rounded-lg">
          <div className="flex items-center space-x-2">
            ...
            <div>
              <div className="font-medium text-gray-900">{current.description}</div>
              <div className="text-sm text-gray-600">風向: {current.windDirection}</div>
            </div>
          </div>
        </div>
      </div>
      ...
      {trend && (
        <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
          ...
          <p className="mt-3 text-gray-700">{trend.description}</p>
        </div>
      )}
    </div>
  );
