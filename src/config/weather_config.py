...
class WeatherConfig:
    ...
    default_location: str = field(default_factory=lambda: os.getenv('DEFAULT_WEATHER_LOCATION', '東京'))
    forecast_hours: int = field(default_factory=lambda: int(os.getenv('WEATHER_FORECAST_HOURS', '24')))
    ...
    rate_limit_delay: float = field(default_factory=lambda: float(os.getenv('WEATHER_API_RATE_LIMIT_DELAY', '0.1')))
    cache_ttl: int = field(default_factory=lambda: int(os.getenv('WEATHER_CACHE_TTL', '300')))  # 5分
    enable_caching: bool = field(default_factory=lambda: os.getenv('WEATHER_ENABLE_CACHING', 'true').lower() == 'true')
