...
class PastCommentCollection:
    ...
    def filter_by_location(self, location: str, exact_match: bool = False) -> 'PastCommentCollection':
        """地点でフィルタリング
    ...
    def filter_by_weather_condition(self, condition: str, fuzzy: bool = True) -> 'PastCommentCollection':
        """天気状況でフィルタリング
        ...
        filtered_comments = [
            c for c in self.comments 
            if c.matches_weather_condition(condition, fuzzy)
        ]
